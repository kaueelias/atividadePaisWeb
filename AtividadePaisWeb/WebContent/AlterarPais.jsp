		...
		<form action="controller.do" method="post">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label for="nome">País</label> <input type="text"
			...
			<div class="row">
				<div class="form-group col-md-6">
					<label for="populacao">População</label> <input type="text"
						class="form-control" name="populacao" placeholder="Populacao"
						maxlength="60" value="${pais.populacao }">
				</div>

				<div class="form-group col-md-6">
					<label for="email">Área</label> <input type="text"
						class="form-control" name="area" required maxlength="60"
						placeholder="Area" value="${pais.area }">
				</div>
			</div>
			<hr />
